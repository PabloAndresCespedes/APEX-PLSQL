...
//==============================================================================================================
    app.get('/', (req, res) => {
        let l_current = new Date(); // (0) domingo (6) sabado
        let l_day   = l_current.getDay();

        res.send(`Este script ejecuta la marcación en Consultagro de forma programada. 
                  Hoy será ejecutado todo lo referente 
                  al día: ${ diasSemana[l_day] }
                `
        );
